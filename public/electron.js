...
import { startSequelize } from '../backend/sequelize/index.js';
import { initServices } from '../backend/service/index.js';
import { initConfig } from '../backend/config.js';
import lookupService from '../backend/service/LookupService.js';
import '../backend/scripts/docReader.js';
import '../backend/scripts/jsonReader.js';
...
const createWindow = () => {
  ...
  mainWindow.loadURL(
    isDev
      ...
      : `file://${path.join(__dirname, './index.html')}` // Production URL there is a problem here, it opens empty
  );
