  ...
  return (
    <div className='h-full relative'>
      <SplitPane
        ...
        resizerStyle={rightPanelCollapsed ? { display: 'none' } : { background: '#809671', cursor: 'col-resize', width: '12px' }}
      >
        <SplitPane
          split="vertical"
          ...
          resizerStyle={leftPanelCollapsed ? { display: 'none' } : { background: '#809671', cursor: 'col-resize', width: '12px' }}
        >
